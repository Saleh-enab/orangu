...
pub(crate) const ORANGU_URL: &str = "https://mnemosyne-systems.github.io/orangu/";

/// The closing attribution shared by every review report — `/review` and
/// `/auto_review` alike — as Markdown: `Generated by: **orangu <version>**`,
/// with the brand name `orangu` linked to the project site and the reviewing
/// model in parentheses (outside the bold) when `model` is non-empty.
pub(crate) fn generated_by_markdown(model: &str) -> String {
...
impl AutoReviewState {
    ...
    pub(crate) fn generated_by_markdown(&self) -> String {
        generated_by_markdown(&self.model)
    }
